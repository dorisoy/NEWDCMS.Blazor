...
namespace DCMS.Domain
{
    ...
    /// 表示科目类别
    /// </summary>
    public class AccountingType : AuditableEntity<int>
    {
    ...
    /// 表示科目项目
    /// </summary>
    public partial class AccountingOption : AuditableEntity<int>
    {
    ...
    public class AccountingOptionTree<T> where T : BaseAccountEntity<int>
    {
        public bool Visible { get; set; }
        public AccountingOption Option { get; set; }
        public int MaxItems { get; set; } = 0;
