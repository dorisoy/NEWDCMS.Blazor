...
namespace DCMS.Domain.Auth
{
	...
	/// 表示权限
	/// </summary>
	public class PermissionRecord : AuditableEntity<int>
	{
	...
	/// 表示权限角色映射
	/// </summary>
	public class PermissionRecordRoles : AuditableEntity<int>
	{
	...
	/// 表示数据和频道权限
	/// </summary>
	public class DataChannelPermission : AuditableEntity<int>
	{
