...
namespace DCMS.Domain.CRM
{
	...
	/// </summary>
	//[Table("CRM_Relations")]
	public class CRM_RELATION : IEntity<int>
	{
		#region DCMS
	...
	/// </summary>
	//[Table("CRM_Returns")]
	public class CRM_RETURN : IEntity<int>
	{
		[Key]
		public int Id { get; set; }
	...
	/// </summary>
	//[Table("CRM_Orgs")]
	public class CRM_ORG : IEntity<int>
	{
		[Key]
		public int Id { get; set; }
		/// <summary>
	...
	/// </summary>
	//[Table("CRM_Bps")]
	public class CRM_BP : IEntity<int>
	{
		[Key]
		public int Id { get; set; }
		/// <summary>
	...
	/// </summary>
	//[Table("CRM_Zsntm0040")]
	public class CRM_ZSNTM0040 : IEntity<int>
	{
		[Key]
		public int Id { get; set; }
		/// <summary>
	...
	/// 终端制高点分类分级配置
	/// </summary>
	//[Table("CRM_HeightConfs")]
	public class CRM_HEIGHT_CONF : IEntity<int>
	{
		[Key]
		public int Id { get; set; }
		/// <summary>
	...
	/// </summary>
	//[Table("CRM_Bustats")]
	public class CRM_BUSTAT : IEntity<int>
	{
		[Key]
		public int Id { get; set; }
		/// <summary>
