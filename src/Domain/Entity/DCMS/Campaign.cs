...
namespace DCMS.Domain.Main
{
    ...
    /// 用于表示购买商品
    /// </summary>
    public class CampaignBuyProduct : AuditableEntity<int>
    {
        /// <summary>
        /// 活动
        /// </summary>
    ...
    /// 用于表示赠送商品
    /// </summary>
    public class CampaignGiveProduct : AuditableEntity<int>
    {
        /// <summary>
        /// 活动
        /// </summary>
    ...
    /// 用于表示促销渠道
    /// </summary>
    public class CampaignChannel : AuditableEntity<int>
    {
        public int CampaignId { get; set; }
    ...
    public class CampaignUpdate : AuditableEntity<int>
    {
