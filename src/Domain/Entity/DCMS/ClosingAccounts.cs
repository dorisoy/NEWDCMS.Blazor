...
namespace DCMS.Domain.Main
{
    ...
    /// 用于表示期末结账
    /// </summary>
    public class ClosingAccounts : AuditableEntity<int>
    {
    ...
    /// 用于表示成本汇总表
    /// </summary>
    public class CostPriceSummery : AuditableEntity<int>
    {
    ...
    /// 用于表示成本变化明细记录
    /// </summary>
    public class CostPriceChangeRecords : AuditableEntity<int>
    {
