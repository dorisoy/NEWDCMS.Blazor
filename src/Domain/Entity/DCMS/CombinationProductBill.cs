...
namespace DCMS.Domain.Main
{
    ...
    /// 用于表示库存商品组合单
    /// </summary>
    public class CombinationProductBill : BaseBillEntity<int,CombinationProductItem>
    {
    ...
    public class CombinationProductItem : AuditableEntity<int>
    {
    ...
    /// 项目保存或者编辑
    /// </summary>
    public class CombinationProductBillUpdate : AuditableEntity<int>
    {
