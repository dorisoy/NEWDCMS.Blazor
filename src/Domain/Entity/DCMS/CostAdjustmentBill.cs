...
namespace DCMS.Domain.Main
{
    ...
    /// 用于表示成本调价单
    /// </summary>
    public class CostAdjustmentBill : BaseBillEntity<int,CostAdjustmentItem>
    {
    ...
    public class CostAdjustmentItem : AuditableEntity<int>
    {
    ...
    /// 项目保存或者编辑
    /// </summary>
    public class CostAdjustmentBillUpdate : AuditableEntity<int>
    {
