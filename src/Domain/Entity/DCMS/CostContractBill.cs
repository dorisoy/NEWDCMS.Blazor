...
namespace DCMS.Domain.Main
{
    ...
    /// 用于表示费用合同单据
    /// </summary>
    public class CostContractBill : BaseBillEntity<int,CostContractItem>
    {
    ...
    /// 用于表示费用合同单据项目
    /// </summary>
    public class CostContractItem : MonthAllocateQuotaModel
    {
    ...
    public class MonthAllocateQuotaModel : BaseFinanceItemEntity<int>
    {
    ...
    /// 项目保存或者编辑
    /// </summary>
    public class CostContractBillUpdate : AuditableEntity<int>
    {
