...
namespace DCMS.Domain.Main
{
    ...
    /// 用于表示费用支出单据
    /// </summary>
    public class CostExpenditureBill : BaseBillEntity<int,CostExpenditureItem>
    {
    ...
    /// 用于表示费用支出单据项目
    /// </summary>
    public class CostExpenditureItem : BaseFinanceItemEntity<int>
    {
    ...
    ///  费用支出账户（费用支出单据科目映射表）
    /// </summary>
    public class CostExpenditureBillAccounting : BaseAccountEntity<int>
    {
    ...
    /// 项目保存或者编辑
    /// </summary>
    public class CostExpenditureBillUpdate : AuditableEntity<int>
    {
