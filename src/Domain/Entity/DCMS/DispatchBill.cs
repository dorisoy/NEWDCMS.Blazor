...
namespace DCMS.Domain.Main
{
    ...
    /// 装车调度单
    /// </summary>
    public class DispatchBill : BaseBillEntity<int,DispatchItem>
    {
        public DispatchBill()
        {
    ...
    /// 调度单明细
    /// </summary>
    public class DispatchItem : BaseItemEntity<int>
    {
    ...
    /// 用于表示单据签收
    /// </summary>
    public class DeliverySign : AuditableEntity<int>
    {
    ...
    /// </summary>
    public class DeliverySignUpdate : AuditableEntity<int>
    {
