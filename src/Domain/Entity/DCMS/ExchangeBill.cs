...
namespace DCMS.Domain.Main
{
    ...
    /// 换货单
    /// </summary>
    public class ExchangeBill : BaseBillEntity<int,ExchangeItem>
    {
    ...
    /// 换货单明细
    /// </summary>
    public class ExchangeItem : BaseItemEntity<int>
    {
        /// <summary>
        /// 税率%
        /// </summary>
    ...
    /// 更新结构
    /// </summary>
    public class ExchangeBillUpdate : AuditableEntity<int>
    {
