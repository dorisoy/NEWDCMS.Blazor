...
namespace DCMS.Domain.Main
{
    ...
    /// 用于表示财务收入单据(其它收入)
    /// </summary>
    public class FinancialIncomeBill : BaseBillEntity<int,FinancialIncomeItem>
    {
    ...
    /// 用于表示财务收入单据项目
    /// </summary>
    public class FinancialIncomeItem : BaseFinanceItemEntity<int>
    {
    ...
    ///  财务收入账户（财务收入单据科目映射表）
    /// </summary>
    public class FinancialIncomeBillAccounting : BaseAccountEntity<int>
    {
    ...
    /// 项目保存或者编辑
    /// </summary>
    public class FinancialIncomeBillUpdate : AuditableEntity<int>
    {
