...
namespace DCMS.Domain.Main
{
    ...
    public class GiveQuota : AuditableEntity<int>
    {
    ...
    /// 表示赠品额度项目
    /// </summary>
    public class GiveQuotaOption : AuditableEntity<int>
    {
        /// <summary>
        /// 商品
        /// </summary>
    ...
    /// 用于表示赠送记录（可用于汇总）
    /// </summary>
    public class GiveQuotaRecords : AuditableEntity<int>
    {
    ...
    public class GiveQuotaUpdate : AuditableEntity<int>
    {
        //移除 = 0;
