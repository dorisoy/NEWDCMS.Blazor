...
namespace DCMS.Domain.Main
{
    ...
    /// 用于表示盘点任务(整仓)
    /// </summary>
    public class InventoryAllTaskBill : BaseBillEntity<int,InventoryAllTaskItem>
    {
    ...
    public class InventoryAllTaskItem : AuditableEntity<int>
    {
    ...
    /// 项目保存或者编辑
    /// </summary>
    public class InventoryAllTaskBillUpdate : AuditableEntity<int>
    {
