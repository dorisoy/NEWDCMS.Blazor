...
namespace DCMS.Domain.Main
{
    ...
    /// 用于表示盘点盈亏单
    /// </summary>
    public class InventoryProfitLossBill : BaseBillEntity<int,InventoryProfitLossItem>
    {
    ...
    public class InventoryProfitLossItem : AuditableEntity<int>
    {
    ...
    /// 项目保存或者编辑
    /// </summary>
    public class InventoryProfitLossBillUpdate : AuditableEntity<int>
    {
