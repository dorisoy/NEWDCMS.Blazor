...
namespace DCMS.Domain.Main
{
    ...
    /// 用于门店库存上报
    /// </summary>
    public class InventoryReportBill : BaseBillEntity<int,InventoryReportItem>
    {
    ...
    /// 上报关联商品
    /// </summary>
    public class InventoryReportItem : AuditableEntity<int>
    {
    ...
    /// 商品关联库存量
    /// </summary>
    public class InventoryReportStoreQuantity : AuditableEntity<int>
    {
    ...
    /// 上报汇总表
    /// </summary>
    public class InventoryReportSummary : AuditableEntity<int>
    {
