...
namespace DCMS.Domain.Main
{
    ...
    /// 用于表示付款单据
    /// </summary>
    public class PaymentReceiptBill : BaseBillEntity<int,PaymentReceiptItem>
    {
    ...
    /// 用于表示付款单据项目
    /// </summary>
    public class PaymentReceiptItem : BaseFinanceItemEntity<int>
    {
    ...
    ///  付款账户（付款单据科目映射表）
    /// </summary>
    public class PaymentReceiptBillAccounting : BaseAccountEntity<int>
    {
        /// <summary>
        /// 供应商
        /// </summary>
    ...
    /// 项目保存或者编辑
    /// </summary>
    public class PaymentReceiptBillUpdate : AuditableEntity<int>
    {
        public string BillNumber { get; set; }
        /// <summary>
        /// 付款人
