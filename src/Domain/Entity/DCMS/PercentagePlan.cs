...
namespace DCMS.Domain.Main
{
    ...
    /// 表示提成方案
    /// </summary>
    public class PercentagePlan : AuditableEntity<int>
    {
    ...
    /// 表示员工提成配置
    /// </summary>
    public class Percentage : AuditableEntity<int>
    {
    ...
    /// 按利润区间范围计算提成
    /// </summary>
    public class PercentageRangeOption : AuditableEntity<int>
    {
        /// <summary>
        /// 净销售额区间范围
        /// </summary>
    ...
    /// 保存序列
    /// </summary>
    public class PercentageSerializeUpdate : AuditableEntity<int>
    {
