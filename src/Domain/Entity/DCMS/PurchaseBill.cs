...
namespace DCMS.Domain.Main
{
    ...
    /// 采购单
    /// </summary>
    public class PurchaseBill : BaseBillEntity<int,PurchaseItem>
    {
        public PurchaseBill()
        {
    ...
    /// 采购单明细
    /// </summary>
    public class PurchaseItem : BaseItemEntity<int>
    {
        /// <summary>
        /// 税率%
        /// </summary>
    ...
    ///  收款账户（采购单科目映射表）
    /// </summary>
    public class PurchaseBillAccounting : BaseAccountEntity<int>
    {
    ...
    /// 项目保存或者编辑
    /// </summary>
    public class PurchaseBillUpdate : AuditableEntity<int>
    {
