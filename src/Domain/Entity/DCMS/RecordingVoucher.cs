...
namespace DCMS.Domain.Main
{
    ...
    /// 用于表示记账凭证
    /// </summary>
    public class RecordingVoucher : BaseBillEntity<int,VoucherItem>
    {
    ...
    /// 用于表示凭证项目
    /// </summary>
    public class VoucherItem : AuditableEntity<int>
    {
        /// <summary>
        /// 记账凭证
        /// </summary>
    ...
    /// 项目保存或者编辑
    /// </summary>
    public class RecordingVoucherUpdate : AuditableEntity<int>
    {
