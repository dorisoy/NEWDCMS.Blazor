...
namespace DCMS.Domain.Main
{
    ...
    /// 退货单
    /// </summary>
    public class ReturnBill : BaseBillEntity<int,ReturnItem>
    {
        public ReturnBill()
        {
    ...
    /// 退货单明细
    /// </summary>
    public class ReturnItem : BaseItemEntity<int>
    {
        /// <summary>
        /// 税率%
        /// </summary>
    ...
    ///  收款账户（销售单科目映射表）
    /// </summary>
    public class ReturnBillAccounting : BaseAccountEntity<int>
    {
    ...
    /// 项目保存或者编辑
    /// </summary>
    public class ReturnBillUpdate : AuditableEntity<int>
    {
