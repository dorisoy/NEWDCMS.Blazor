...
namespace DCMS.Domain.Main
{
    ...
    /// 退货订单
    /// </summary>
    public class ReturnReservationBill : BaseBillEntity<int,ReturnReservationItem>
    {
    ...
    /// 退货订单明细
    /// </summary>
    public class ReturnReservationItem : BaseItemEntity<int>
    {
        /// <summary>
        /// 税率%
        /// </summary>
    ...
    ///  收款账户（退货订单单科目映射表）
    /// </summary>
    public class ReturnReservationBillAccounting : BaseAccountEntity<int>
    {
    ...
    /// 项目保存或者编辑
    /// </summary>
    public class ReturnReservationBillUpdate : AuditableEntity<int>
    {
