...
namespace DCMS.Domain.Main
{
    ...
    /// 销售单
    /// </summary>
    public class SaleBill : BaseBillEntity<int,SaleItem>
    {
        public SaleBill()
        {
    ...
    /// 销售单明细
    /// </summary>
    public class SaleItem : BaseItemEntity<int>
    {
    ...
    ///  收款账户（销售单科目映射表）
    /// </summary>
    public class SaleBillAccounting : BaseAccountEntity<int>
    {
    ...
    /// 项目保存或者编辑
    /// </summary>
    public class SaleBillUpdate : AuditableEntity<int>
    {
