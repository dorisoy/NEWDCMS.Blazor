...
namespace DCMS.Domain.Main
{
	...
	/// 业务员排行榜（API）
	/// </summary>
	public class BusinessRanking : AuditableEntity<int>
	{
	...
	/// 品牌销量汇总(API)
	/// </summary>
	public class BrandRanking : AuditableEntity<int>
	{
		/// <summary>
		/// 品牌
		/// </summary>
	...
	/// 热销排行榜(API)
	/// </summary>
	public class HotSaleRanking : AuditableEntity<int>
	{
		/// <summary>
		/// 商品
		/// </summary>
	...
	{
		public List<Ranking> RankTabs { get; set; }
