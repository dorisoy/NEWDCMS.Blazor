...
namespace DCMS.Domain.Main
{
    ...
    /// 销售订单
    /// </summary>
    public class SaleReservationBill : BaseBillEntity<int,SaleReservationItem>
    {
    ...
    /// 销售订单明细
    /// </summary>
    public class SaleReservationItem : BaseItemEntity<int>
    {
        /// <summary>
        /// 税率%
        /// </summary>
    ...
    ///  收款账户（销售订单科目映射表）
    /// </summary>
    public class SaleReservationBillAccounting : BaseAccountEntity<int>
    {
        #region Fields
    ...
    public class SaleReservationBillUpdate : AuditableEntity<int>
    {
