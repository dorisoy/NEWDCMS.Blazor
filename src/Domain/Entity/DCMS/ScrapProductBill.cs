...
namespace DCMS.Domain.Main
{
    ...
    /// 用于表示商品报损单
    /// </summary>
    public class ScrapProductBill : BaseBillEntity<int,ScrapProductItem>
    {
    ...
    public class ScrapProductItem : AuditableEntity<int>
    {
    ...
    /// 项目保存或者编辑
    /// </summary>
    public class ScrapProductBillUpdate : AuditableEntity<int>
    {
