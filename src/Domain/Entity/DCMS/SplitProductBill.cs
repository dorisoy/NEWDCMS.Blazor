...
namespace DCMS.Domain.Main
{
    ...
    /// 用于表示库存商品拆分单
    /// </summary>
    public class SplitProductBill : BaseBillEntity<int,SplitProductItem>
    {
    ...
    public class SplitProductItem : AuditableEntity<int>
    {
    ...
    /// 项目保存或者编辑
    /// </summary>
    public class SplitProductBillUpdate : AuditableEntity<int>
    {
