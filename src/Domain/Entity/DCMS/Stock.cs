...
namespace DCMS.Domain.Main
{
    ...
    /// 用于表示出入库业务记录
    /// </summary>
    public class StockInOutRecord : AuditableEntity<int>
    {
    ...
    /// 用于表示库存流水(更改历史)记录
    /// </summary>
    public class StockFlow : AuditableEntity<int>
    {
    ...
    /// 用于表示出入库记录和流水映射
    /// </summary>
    public class StockInOutRecordStockFlow : AuditableEntity<int>
    {
    ...
    /// 用于表示商品库存信息
    /// </summary>
    public class ProductStockItem: BaseItemEntity<int>
    {
        public string ProductName { get; set; }
        public string ProductCode { get; set; }
        public int SmallUnitId { get; set; }
    ...
    /// 用于商品出入库明细记录
    /// </summary>
    public class StockInOutDetails : AuditableEntity<int>
    {
        /// <summary>
        /// 库存Id
        /// </summary>
    ...
    /// 实时库存查询
    /// </summary>
    public class RealTimeStockQuery
    {
