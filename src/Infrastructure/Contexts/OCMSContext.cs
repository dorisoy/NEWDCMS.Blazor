...
using DCMS.Infrastructure.Mapping.OCMS;
...
{
	public class OCMSContext : AuditableBaseContext
	{
		private readonly ICurrentUserService _currentUserService;
		private readonly IDateTimeService _dateTimeService;

		public OCMSContext(DbContextOptions<OCMSContext> options, ICurrentUserService currentUserService, IDateTimeService dateTimeService)
			: base(options)
		{
