...
namespace DCMS.Infrastructure.Repositories
{
    public class ExtendedAttributeUnitOfWork<TId, TEntityId, TEntity> : IExtendedAttributeUnitOfWork<TId, TEntityId, TEntity> where TEntity : AuditableEntity<TEntityId>
    {
        ...
        private readonly Contexts.MainContext _dbContext;
        private bool _disposed;
        private Hashtable _repositories;
        private readonly IAppCache _cache;

        public ExtendedAttributeUnitOfWork(Contexts.MainContext dbContext, ICurrentUserService currentUserService, IAppCache cache)
        {
