    ...
    public class RoleService : IRoleService
    {
        ...
        public async Task<Result<PermissionModel>> GetAllPermissionsAsync(string roleId)
        {
            ...
            if (role != null)
            {
                ...
                {
                    model.RoleClaims = new List<RoleClaimModel>();
                    return await Result<PermissionModel>.FailAsync(roleClaimsResult.Messages);
                }
            }
            model.RoleClaims = allPermissions;
            return await Result<PermissionModel>.SuccessAsync(model);
        }
