...
namespace DCMS.Infrastructure.Services.Identity
{
    public class UserService : IUserService
    {
        ...
        public async Task<IResult<UserRolesModel>> GetRolesAsync(string userId)
        {
            ...
            var result = new UserRolesModel { UserRoles = viewModel };
            return await Result<UserRolesModel>.SuccessAsync(result);
        }
        ...
        public async Task<string> ExportToExcelAsync(string searchString = "")
        {
            ...
            var result = await _excelService.ExportAsync(users, sheetName: _localizer["Users"],
                mappers: new Dictionary<string, Func<AppUser, object>>
                {
                    ...
                    { _localizer["UserRealName"], item => item.UserRealName },
